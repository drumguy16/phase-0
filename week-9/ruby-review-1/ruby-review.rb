...
# A:This challenge was a review in debugging code using error messages.

# Q:What is still confusing to you about Ruby?
# A:I think I just need more practice refactoring existing code. 

# Q:What are you going to study to get more prepared for Phase 1?
# A:I plan to research useful tips for refactoring. i.e. Common things to look for that could be simplified or written in a more readable fashion. I will make a cheat sheet.